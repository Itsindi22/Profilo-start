...
import { Loader as DreiLoader } from "@react-three/drei"; // renamed to avoid conflict
  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      ...
      .then(() => {
        ...
        setCurrentAnimation('idle')
        console.log(error);
        showAlert({ show: true, text:'I dint receive your message',
          type: "danger"
        })
      });
  };
  ...
  return (
    <section className="relative flex Lg:flex-row flex-col max-container">
      ...
      <div className="lg:w-1/2 w-full lg:h-auto md:h-[550px] h-[350px]">
        ...
        {/* Drei Loader to show global progress */}
        <DreiLoader />
      </div>
    </section>
  );
